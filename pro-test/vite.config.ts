...
export default defineConfig({
  ...
  base: '/pro/',
  // Read the repo root's .env files, the same ones the dashboard build reads.
  // Both apps sign in against one Supabase project, so keeping a second copy
  // of VITE_SUPABASE_* in here is how they would drift apart.
