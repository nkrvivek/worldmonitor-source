...
export const DASHBOARD_URL = 'https://worldmonitor.sibt.ai/dashboard';
...
// buildDashboardCheckoutReturnUrl). Use this as the provider `return_url`: unlike
// `?wm_checkout=success`, the `return` marker only reconciles success when
// paired with authoritative provider evidence (subscription_id/payment_id + a
