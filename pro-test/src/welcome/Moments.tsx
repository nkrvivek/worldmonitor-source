...
const MOMENTS: MomentConfig[] = [
  { key: 'm1', twoLineTitle: true, signals: ['RISK', 'FLOW', 'MACRO', 'PRICE'], chips: ['free', 'free', 'pro', 'pro'], href: 'https://worldmonitor.sibt.ai/finance?ref=welcome-m1' },
  { key: 'm2', twoLineTitle: true, signals: ['AIS', 'WEATHER', 'SUPPLY', 'SPREAD'], chips: ['free', 'free', 'pro', 'pro'], href: 'https://worldmonitor.sibt.ai/commodity?ref=welcome-m2' },
  { key: 'm3', twoLineTitle: true, signals: ['AI', 'GRID', 'CLIMATE', 'MARKET'], chips: ['free', 'free', 'pro', 'pro'], href: 'https://worldmonitor.sibt.ai/tech?ref=welcome-m3' },
