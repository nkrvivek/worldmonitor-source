...
export const Logo = () => (
  <a href="https://worldmonitor.sibt.ai" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="World Monitor — Home">
    ...
    <div className="flex flex-col">
      ...
      <span className="text-[9px] text-wm-muted font-mono uppercase tracking-widest leading-none mt-1">{SITE_BYLINE}</span>
    </div>
  </a>
);
