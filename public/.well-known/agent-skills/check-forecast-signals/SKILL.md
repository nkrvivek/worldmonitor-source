...
```
GET https://worldmonitor.sibt.ai/api/forecast/v1/get-forecasts
GET https://worldmonitor.sibt.ai/api/forecast/v1/get-forecast-scorecard
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/forecast/v1/get-forecasts' \
...
- Via MCP, use forecast-generation and prediction-market tools on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operations `GetForecasts` and `GetForecastScorecard`.
