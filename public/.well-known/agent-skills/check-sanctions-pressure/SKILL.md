...
```
GET https://worldmonitor.sibt.ai/api/sanctions/v1/list-sanctions-pressure
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/sanctions/v1/list-sanctions-pressure' \
...
- Via MCP, the equivalent tool is `get_sanctions_data` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListSanctionsPressure`.
