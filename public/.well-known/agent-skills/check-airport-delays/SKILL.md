...
```
GET https://worldmonitor.sibt.ai/api/aviation/v1/list-airport-delays
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/aviation/v1/list-airport-delays' \
...
- Via MCP, the equivalent tool is `get_aviation_status` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListAirportDelays`.
