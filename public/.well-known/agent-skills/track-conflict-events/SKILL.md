...
```
GET https://worldmonitor.sibt.ai/api/conflict/v1/list-ucdp-events
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/conflict/v1/list-ucdp-events' \
...
- Via MCP, the equivalent tool is `get_conflict_events` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListUcdpEvents`.
