...
```
GET https://worldmonitor.sibt.ai/api/military/v1/list-military-flights
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/military/v1/list-military-flights' \
...
- Via MCP, the equivalent tool is `get_military_posture` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListMilitaryFlights`.
