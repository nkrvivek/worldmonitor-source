...
```
GET https://worldmonitor.sibt.ai/api/health/v1/list-disease-outbreaks
GET https://worldmonitor.sibt.ai/api/health/v1/list-air-quality-alerts
```
...
curl -s --get \
  ...
  'https://worldmonitor.sibt.ai/api/health/v1/list-disease-outbreaks' \
...
- Via MCP, use the health or advisories tools on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operations `ListDiseaseOutbreaks` and `ListAirQualityAlerts`.
