...
```
GET https://worldmonitor.sibt.ai/api/news/v1/list-feed-digest
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/news/v1/list-feed-digest' \
...
- Via MCP, the equivalent tool is `get_news_intelligence` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListFeedDigest`.
