...
```
GET https://worldmonitor.sibt.ai/api/prediction/v1/list-prediction-markets
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/prediction/v1/list-prediction-markets' \
...
- Via MCP, the equivalent tool is `get_prediction_markets` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListPredictionMarkets`.
