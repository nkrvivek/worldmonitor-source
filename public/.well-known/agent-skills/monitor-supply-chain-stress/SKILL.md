...
```
GET https://worldmonitor.sibt.ai/api/supply-chain/v1/get-shipping-stress
```
...
curl -s -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/supply-chain/v1/get-shipping-stress' \
...
- Via MCP, the equivalent supply-chain surface is available through `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operation `GetShippingStress`.
