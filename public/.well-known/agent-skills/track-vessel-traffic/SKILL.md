...
```
GET https://worldmonitor.sibt.ai/api/maritime/v1/get-vessel-snapshot
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/maritime/v1/get-vessel-snapshot' \
...
- Via MCP, the equivalent tool is `get_maritime_activity` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `GetVesselSnapshot`.
