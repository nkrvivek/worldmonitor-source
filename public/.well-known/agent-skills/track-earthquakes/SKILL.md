...
```
GET https://worldmonitor.sibt.ai/api/seismology/v1/list-earthquakes
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/seismology/v1/list-earthquakes' \
...
- Via MCP, the equivalent tool is `get_natural_disasters` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListEarthquakes`.
