...
```
GET https://worldmonitor.sibt.ai/api/intelligence/v1/get-country-risk
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/intelligence/v1/get-country-risk' \
...
- Via MCP, the equivalent tool is `get_country_risk` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `GetCountryRisk`.
