...
```
GET https://worldmonitor.sibt.ai/api/market/v1/list-market-quotes
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/market/v1/list-market-quotes' \
...
- Via MCP, the equivalent tool is `get_market_data` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListMarketQuotes`.
