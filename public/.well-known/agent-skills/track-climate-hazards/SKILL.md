...
Issue a key at https://worldmonitor.sibt.ai/pro.

## Endpoints

```
GET https://worldmonitor.sibt.ai/api/climate/v1/list-climate-disasters
GET https://worldmonitor.sibt.ai/api/climate/v1/list-climate-anomalies
GET https://worldmonitor.sibt.ai/api/climate/v1/list-climate-news
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/climate/v1/list-climate-disasters' \
...
- Via MCP, use the climate or disaster intelligence tools on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operations `ListClimateDisasters`, `ListClimateAnomalies`, and `ListClimateNews`.
