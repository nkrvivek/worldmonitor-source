...
```
GET https://worldmonitor.sibt.ai/api/infrastructure/v1/list-internet-outages
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/infrastructure/v1/list-internet-outages' \
...
- Via MCP, the equivalent tool is `get_infrastructure_status` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListInternetOutages`.
