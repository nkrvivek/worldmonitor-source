...
```
GET https://worldmonitor.sibt.ai/api/trade/v1/get-tariff-trends
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/trade/v1/get-tariff-trends' \
...
- Via MCP, the equivalent tool is `get_tariff_trends` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `GetTariffTrends`.
