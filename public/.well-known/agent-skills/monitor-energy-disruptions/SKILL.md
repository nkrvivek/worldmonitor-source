...
```
GET https://worldmonitor.sibt.ai/api/supply-chain/v1/list-energy-disruptions
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/supply-chain/v1/list-energy-disruptions' \
...
- Via MCP, use the energy-intelligence or supply-chain tool set on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operation `ListEnergyDisruptions`.
- Methodology: https://worldmonitor.sibt.ai/docs/methodology/disruptions
