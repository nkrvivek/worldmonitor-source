...
```
GET https://worldmonitor.sibt.ai/api/cyber/v1/list-cyber-threats
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://worldmonitor.sibt.ai/api/cyber/v1/list-cyber-threats' \
...
- Via MCP, the equivalent tool is `get_cyber_threats` on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json — operation `ListCyberThreats`.
