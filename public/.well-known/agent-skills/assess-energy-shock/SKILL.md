...
```
GET https://worldmonitor.sibt.ai/api/intelligence/v1/compute-energy-shock
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/intelligence/v1/compute-energy-shock' \
...
- Via MCP, use the energy or supply-chain tools on `https://worldmonitor.sibt.ai/mcp` and include the same country/chokepoint parameters.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operation `ComputeEnergyShockScenario`.
