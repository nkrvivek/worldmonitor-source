...
```
GET https://worldmonitor.sibt.ai/api/trade/v1/list-comtrade-flows
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  ...
  'https://worldmonitor.sibt.ai/api/trade/v1/list-comtrade-flows' \
...
- Via MCP, use the trade and supply-chain tools on `https://worldmonitor.sibt.ai/mcp`.

## References

- OpenAPI: https://worldmonitor.sibt.ai/openapi.json - operation `ListComtradeFlows`.
