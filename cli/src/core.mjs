...
//
// The CLI is MCP-first. The MCP server (https://worldmonitor.sibt.ai/mcp) is the
...
// This deployment's hosts. Upstream ships api.worldmonitor.app here; on a key
// issued by this instance that sends the key to a server we do not run and
// returns 403. Override per call with --base-url / --mcp-url, or the matching
// WORLDMONITOR_* env vars. See FORK.md, "Client defaults point at our host".
export const DEFAULT_BASE_URL = 'https://worldmonitor.sibt.ai';
export const DEFAULT_MCP_URL = 'https://worldmonitor.sibt.ai/mcp';
export const DEFAULT_SPEC_URL = 'https://worldmonitor.sibt.ai/openapi.json';
...
export const AUTH_HINT =
  'Hint: this call needs a key — pass --api-key or set WORLDMONITOR_API_KEY (get one at https://worldmonitor.sibt.ai/pro).';
...
Get an API key at https://worldmonitor.sibt.ai/pro · docs https://worldmonitor.sibt.ai/docs/cli`;
