...
[MCP server](https://worldmonitor.sibt.ai/mcp) (the recommended agent surface) with
...
- `--mcp-url <url>` — MCP endpoint (default `https://worldmonitor.sibt.ai/mcp`)
- `--base-url <url>` — REST base (default `https://worldmonitor.sibt.ai`)
