...
export const SEED_ENV_NAMES = [
  ...
  // X402_PAYMENT_REQUIRED, which is what kept this blocked. seed-grocery-
  // basket stays unscheduled: it needs FIRECRAWL_API_KEY as well, and we hold
  // no Firecrawl credential.
  'EXA_API_KEY',
  'EXA_API_KEYS',
...
export const SEED_ENV_NOT_FORWARDED: Readonly<Record<string, string>> = {
  ...
  WORLDMONITOR_API_KEY: 'self-call credential; no reachable seed needs it',
