...
export const SEED_JOBS: readonly SeedJob[] = [
  ...
  // WORLDMONITOR_RELAY_KEY + API_BASE_URL, which containers deliberately do
  // not receive (SEED_ENV_NOT_FORWARDED) — there it degrades to a graceful
  // skip on a cold cache; the GitHub fallback carries both and runs it fully.
