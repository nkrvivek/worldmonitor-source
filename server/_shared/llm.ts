...
import { GROQ_FALLBACK_MODEL, GROQ_EXTRA_BODY } from '../../shared/groq-model.js';
...
export function getProviderCredentials(
  ...
  if (provider === 'groq') {
    ...
    return {
      ...
      model: overrides.model || GROQ_FALLBACK_MODEL,
      headers: {
...
// via OpenRouter; groq is the free-tier/outage
