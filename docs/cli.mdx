...
Data commands map to MCP `tools/call` and require a user API key. Grab one at [worldmonitor.sibt.ai/pro](https://worldmonitor.sibt.ai/pro), then either pass it per-call or export it once:
