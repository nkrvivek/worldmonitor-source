...
Starts the OAuth flow. Renders a consent page that redirects to the Supabase sign-in flow, then issues an authorization code bound to the caller's PRO entitlement.
