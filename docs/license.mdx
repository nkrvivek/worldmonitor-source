...
This site runs a modified version of World Monitor, so section 13 of the AGPL
obliges us to offer you its source. That source is at
[nkrvivek/worldmonitor-source](https://github.com/nkrvivek/worldmonitor-source),
republished on every change. It is the code behind worldmonitor.sibt.ai, not the
upstream project — [koala73/worldmonitor](https://github.com/koala73/worldmonitor)
holds the original code and its issue tracker.
