...
1. 打开 [World Monitor 仪表盘](https://worldmonitor.sibt.ai/dashboard)，使用拥有该 API 订阅的账户登录。
...
如果你已经购买了 API 套餐，请确认你是使用拥有该订阅的账户登录的。如果套餐仍未被识别，请从购买时使用的邮箱地址发送邮件至 [hello@sibt.ai](mailto:hello@sibt.ai)。请附上套餐名称，如有可能，仅提供简短的密钥前缀——**切勿发送完整密钥**。
