...
```
https://worldmonitor.sibt.ai/api/<domain>/v<major>/<operation>
```
...
The bundled [OpenAPI specification](https://worldmonitor.sibt.ai/openapi.yaml)
...
Link: <https://worldmonitor.sibt.ai/docs/api-versioning>; rel="deprecation"; type="text/html"
```
