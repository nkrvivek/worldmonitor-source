...
The MCP server (https://worldmonitor.sibt.ai/mcp) is the live, documented agent
...
# returns 403. Override with base_url=/mcp_url= or the WORLDMONITOR_* env vars.
# See FORK.md, "Client defaults point at our host".
...
AUTH_HINT = (
    ...
    "(get one at https://worldmonitor.sibt.ai/pro)."
)
