...
# (https://worldmonitor.sibt.ai/mcp) is the live, documented agent surface:
...
module WorldMonitor
  ...
  # returns 403. Override with base_url:/mcp_url: or the WORLDMONITOR_* env
  # vars. See FORK.md, "Client defaults point at our host".
  DEFAULT_BASE_URL = "https://worldmonitor.sibt.ai"
  DEFAULT_MCP_URL = "https://worldmonitor.sibt.ai/mcp"
  ...
  AUTH_HINT = "Hint: this call needs a key - pass api_key: or set " \
              "WORLDMONITOR_API_KEY (get one at https://worldmonitor.sibt.ai/pro)."
