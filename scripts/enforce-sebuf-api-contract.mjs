 ...
 *
 * Skips: underscore-prefixed helpers, *.test.*, *.d.ts, and anything gitignored (the
...
function isSourceFile(path) {
  ...
  // A .d.ts declares the types of a route that already exists beside it; it
  // serves no request and cannot be a gateway. api/oauth/register.d.ts and
  // api/oauth/authorize.d.ts are the case that surfaced this.
