...
const STRESS_INDEX_TTL = 93600; // 26h — survive daily cron scheduling drift
const FRED_TTL = 93600; // 26h — survive daily cron scheduling drift
const ENERGY_TTL = 93600; // 26h — survive daily cron scheduling drift
const CAPACITY_TTL = 93600; // 26h — survive daily cron scheduling drift
const MACRO_TTL = 93600; // 26h — survive daily cron drift and extended Yahoo outages
