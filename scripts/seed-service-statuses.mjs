...
// seed-fallback.yml points API_BASE_URL at the fork's own gateway; the
// upstream author's host is only the local-dev default.
const RPC_URL = `${process.env.API_BASE_URL || 'https://api.worldmonitor.app'}/api/infrastructure/v1/list-service-statuses`;
