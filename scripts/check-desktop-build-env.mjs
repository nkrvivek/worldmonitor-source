...
export const REQUIRED_DESKTOP_BUILD_ENV = [
  ...
  'VITE_SUPABASE_URL', //       sign-in; absent => auth disabled entirely
  'VITE_SUPABASE_ANON_KEY', //  the other half of the same pair
...
export const EXCLUDED_DESKTOP_BUILD_ENV = {
  ...
  VITE_PAYMENTS_ENVIRONMENT: 'dormant checkout overlay; desktop checkout flow is #5911',
