...
export const FRESHNESS_REGISTRY = [
  ...
  { key: 'economic:macro-signals:v1',            maxAgeMin: 1560,  feedsAxes: ['capital_stress'] }, // seed-economy is a DAILY cron (`0 9 * * *`); 1560min matches api/health.js macroSignals.maxStaleMin so snapshots don't mark it stale hours after a healthy daily seed.
  ...
  { key: 'economic:stress-index:v1',             maxAgeMin: 1560,  feedsAxes: ['capital_stress'] }, // computed in the same daily seed-economy run; 1560min matches api/health.js economicStress.maxStaleMin.
