...
const SANDBOX_NOTE =
  ...
  `Guide: ${SITE_ORIGIN}/docs/sandbox`;
...
export function buildSandboxFixtures(repoRoot = root) {
  ...
  for (const path of SANDBOX_OPERATIONS) {
    ...
    const fixture = {
      ...
      operation: {
        ...
        path,
        summary: op.summary ?? '',
        productionUrl: `https://worldmonitor.sibt.ai${path}`,
    ...
    indexOperations.push({
      ...
      fixture: `${SITE_ORIGIN}/sandbox/${slug}.json`,
  ...
  const index = {
    ...
    docs: `${SITE_ORIGIN}/docs/sandbox`,
    openapi: `${SITE_ORIGIN}/openapi.json`,
    authGuide: `${SITE_ORIGIN}/auth.md`,
