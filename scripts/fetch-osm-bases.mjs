...
// The main instance answers 504 under load for the global query; the kumi
// mirror usually has headroom. Override to switch without an edit.
  ...
  try {
    const res = await fetch(OVERPASS_URL, {
      ...
      headers: {
        ...
        // overpass-api.de answers 406 to a request with no User-Agent, which
        // is what Node's fetch sends. Their usage policy asks callers to
        // identify themselves.
        'User-Agent': 'worldmonitor-seed/1.0 (github.com/nkrvivek/worldmonitor)',
      },
