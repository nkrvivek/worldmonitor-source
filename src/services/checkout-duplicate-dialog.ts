 ...
 *
 * Every blocked pairing now points at the billing portal. The Pro → Pro
 * Business variant that spelled out a cancel-then-rebuy went away with Pro
 * Business itself on 2026-08-05: the paid plans that remain are one Pro and
 * the API tier, and the portal can move a subscriber between them.
 *
