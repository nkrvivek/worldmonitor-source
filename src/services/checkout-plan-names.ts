...
// The names must match `displayName` in convex/config/productCatalog.ts. The
// `api_starter*` keys are sold as "API" — the key kept its old name so stored
// subscriptions and about sixty call sites did not have to be rewritten.
