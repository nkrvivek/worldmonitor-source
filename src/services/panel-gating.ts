...
// Absolute origin: the desktop runtime's webview has no site origin of its
// own, so a relative href would resolve against tauri://localhost.
const PRO_PAGE_ORIGIN = SITE_ORIGIN;
