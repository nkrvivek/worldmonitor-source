...
/**
 * Fork-owned change: `url` sets each variant's canonical link, og:url,
 * twitter:url and JSON-LD. Upstream points every one at its own subdomain,
 * so a share of our dashboard opened upstream's site and search engines read
 * our pages as copies of theirs. We serve the variants as paths on one host.
 */
