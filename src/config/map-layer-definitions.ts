...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  ...
  ciiChoropleth: {
    ...
    freshness: 'Risk-score cache is warm-pinged every 15 minutes; seed-meta and health.riskScores expose live, stale, partial, or degraded state against a 45-minute freshness budget.',
