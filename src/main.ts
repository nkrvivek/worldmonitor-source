...
// On worldmonitor.app hosts, route RPC calls through the edge API origin.
// Everywhere else (this fork included) it installs nothing and /api stays
// same-origin — see getConfiguredWebApiBaseUrl in services/runtime.ts.
