...
// #6059 — WorldMonitor health reads this marker to tell a market that has never
// published apart from one that published and then broke. Writing it too eagerly
// claims a market ran when it did not; writing it with a TTL lets an activated
// market read as never-activated again.
