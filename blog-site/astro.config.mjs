...
// Shared with the root build so the blog sitemap and the root sitemap name the
// same host. robots.txt advertises both; a blog on a second host would send
// crawlers somewhere we do not answer.
