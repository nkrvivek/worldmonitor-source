...
// The `---` block at the top of a post, parsed. Was gray-matter, which pins
// js-yaml 3 — a line with no fix for GHSA-5p4m-2wfm-xmqj, since the CVE-2026-59870
// patch was never backported off 4.x. Only the two frontmatter fields below are
// read, so the block does not earn a dependency.
