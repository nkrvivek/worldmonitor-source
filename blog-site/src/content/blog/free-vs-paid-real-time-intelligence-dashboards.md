...
| Prosumer / analyst | ~$30–80/month | AI analysis, digests, alerting, personal workflows | World Monitor Pro at $29/month |
| API / developer | ~$100–250/month | Programmatic quotas, webhooks, structured data | World Monitor API at $49–299.99/month |
...
| Pro | $29/month or $290/year | Analysts: WM Analyst chat with citations, Scenario Engine, Route Explorer, AI digest, MCP access with 59 tools |
| API | $49/month or $490.99/year | Developers: REST access, 1,000 requests/day, 5 webhook rules, OpenAPI docs |
| API Business | $299/month | Teams: 300 requests/minute, 10,000 requests/day, priority support |
...
Around $30–80/month for the prosumer tier. World Monitor Pro is $29/month ($290/year). Compare that against enterprise anchors — Bloomberg Terminal at $24,000/year per seat, Dataminr licenses in six figures — and price the specific capability gap, not the brand.
