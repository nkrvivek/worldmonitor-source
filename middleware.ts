...
const VARIANT_OG: Record<string, { name: string; title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://worldmonitor.sibt.ai/favico/tech/og-image.png',
    url: 'https://worldmonitor.sibt.ai/tech',
  },
  finance: {
    name: 'Finance Monitor',
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://worldmonitor.sibt.ai/favico/finance/og-image.png',
    url: 'https://worldmonitor.sibt.ai/finance',
  },
  commodity: {
    ...
    image: 'https://worldmonitor.sibt.ai/favico/commodity/og-image.png',
    url: 'https://worldmonitor.sibt.ai/commodity',
  },
  happy: {
    name: 'Happy Monitor',
    ...
    image: 'https://worldmonitor.sibt.ai/favico/happy/og-image.png',
    url: 'https://worldmonitor.sibt.ai/happy',
  },
  energy: {
    name: 'Energy Atlas',
    ...
    image: 'https://worldmonitor.sibt.ai/favico/energy/og-image.png',
    url: 'https://worldmonitor.sibt.ai/energy',
  },
};
...
<ul>
<li><a href="https://worldmonitor.sibt.ai/dashboard">World Monitor — geopolitics &amp; intelligence</a></li>
<li><a href="https://worldmonitor.sibt.ai/tech">Tech Monitor</a></li>
<li><a href="https://worldmonitor.sibt.ai/finance">Finance Monitor</a></li>
<li><a href="https://worldmonitor.sibt.ai/commodity">Commodity Monitor</a></li>
<li><a href="https://worldmonitor.sibt.ai/happy">Happy Monitor</a></li>
<li><a href="https://worldmonitor.sibt.ai/pro">World Monitor Pro</a></li>
<li><a href="https://worldmonitor.sibt.ai/blog/">Blog</a></li>
