...
// The fixture is a production snapshot taken on 2026-07-30, and the pool
// builder drops markets whose endDate has passed. Read on the wall clock, every
// count assertion below rots the day a fixture market expires: the RBI
// repo-rate market ended 2026-08-05T00:00:00Z and took "no market may be
// dropped by the partition" (45 !== 46) down with it, months after anyone
// touched the classifier. Judge the snapshot at the moment it was captured.
const FIXTURE_CAPTURED_AT = Date.parse('2026-07-30T00:00:00Z');
const realDateNow = Date.now;
Date.now = () => FIXTURE_CAPTURED_AT;
after(() => {
