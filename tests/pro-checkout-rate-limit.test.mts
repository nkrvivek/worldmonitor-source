...
const stubSources: Record<string, string> = {
  ...
  `,
  // A signed-in buyer: startCheckout hands off to the sign-in modal when
  // getCurrentUser() is null, and this test is about what happens after.
  './auth': `
    export async function ensureAuth() {}
    export function getCurrentUser() {
      return { id: 'user_rate_limited', email: 'buyer@example.com' };
    }
