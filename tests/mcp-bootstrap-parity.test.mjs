...
const EXCLUDED_FROM_MCP = new Map([
  ...
  // ===========================================================================
  // The two relay:heartbeat:* rows that sat here left with the Node relay that
  // wrote them (api/health.js). An exclusion for a key nothing seeds is a dead
  // exclusion, and the test below rejects those.
  ['digest:last-run',
