...
describe('quantified cross-Strait activity (#5575)', () => {
  ...
  it('parses the MND list markup served since 2026-09-02, where the date is a div.date not an h5', () => {
    // Live page, fetched 2026-09-03: <div class="date headline-h5 h5">2026.09.03</div>.
    // The previous markup was <h5 class="date">. The parser found 0 rows on the
    // new page, so the source read as SEED_ERROR with no error code from
    // 2026-09-02T07:25Z until this case was added.
    const liveList = `<div class="news_list_box">
      <a href="/en/News/PLAAct/87672" class="news_list">
        <div class="date headline-h5 h5">2026.09.03</div>
        <h2 class="title headline-h4">PLA activities in the waters and airspace around Taiwan</h2>
        <div class="views body-2">Click-Through Rate：15</div>
        <div class="arrow"><i class="bi bi-chevron-right"></i></div>
      </a>
      <a href="/en/News/PLAAct/87662" class="news_list">
        <div class="date headline-h5 h5">2026.09.02</div>
        <h2 class="title headline-h4">PLA activities in the waters and airspace around Taiwan</h2>
      </a>
    </div>`;
    assert.deepEqual(parseTaiwanMndList(liveList), [
      { publicationDay: '2026-09-03', sourceUrl: 'https://www.mnd.gov.tw/en/News/PLAAct/87672' },
      { publicationDay: '2026-09-02', sourceUrl: 'https://www.mnd.gov.tw/en/News/PLAAct/87662' },
    ]);
  });
