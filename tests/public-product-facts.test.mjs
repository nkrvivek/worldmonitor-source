...
describe('public product facts generation contract', () => {
  it('publishes generated lifecycle, pricing, and capability facts', () => {
    ...
    // Read the catalog, not a pinned host. This fork serves the product from
    // its own origin, and a literal here made the rename a test failure.
    assert.equal(sharedFacts.product.pricingUrl, PUBLIC_PRODUCT_METADATA.pricingUrl);
