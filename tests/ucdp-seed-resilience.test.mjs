...
const SOURCE_SCAN_IGNORED_DIRS = new Set([
  '.git',
  '.vercel',
  // Checkouts of other branches, git-ignored and never this tree's source. A
  // worktree holding a copy of scripts/ais-relay.cjs made the writer audit
  // below report four paths where the repo has two, failing the guard on a
  // clean tree, and walking their node_modules took the scan from instant to
  // 76 seconds.
  '.worktrees',
  'worktrees',
