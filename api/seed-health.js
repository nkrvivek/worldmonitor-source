...
const SEED_DOMAINS = {
  ...
  // 30 = the '11,41 * * * *' container cron; this endpoint flags stale at
  // intervalMin*2. Was 15, the retired Railway relay's cadence.
  'market:sectors':           { key: 'seed-meta:market:sectors',           intervalMin: 30 },
  ...
  'intelligence:risk-scores': { key: 'seed-meta:intelligence:risk-scores', intervalMin: 15 }, // warm-ping.yml every 15min; 3x cadence = 45min, aligned with api/health.js riskScores.
