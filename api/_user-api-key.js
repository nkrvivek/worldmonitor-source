...
// buyer looks like between checkout return and the Stripe webhook landing, so a
...
const ENTITLEMENT_ENV_PREFIX = process.env.PAYMENTS_ENVIRONMENT === 'live_mode' ? 'live' : 'test';
