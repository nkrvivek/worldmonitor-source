 ...
 * `x` is fixed — its private half is held out-of-repo (operator vault + Worker
 * secret). Only the validity window rolls.
 *
...
// private half lives out-of-repo (operator vault + WEB_BOT_AUTH_ED25519_PRIVATE_KEY).
// Rotating the key = regenerate the pair and replace this constant; `kid`
